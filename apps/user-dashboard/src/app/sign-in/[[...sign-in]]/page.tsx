...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-[#0e0e0e] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute top-[20%] left-[10%] w-[40%] h-[40%] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[20%] right-[10%] w-[30%] h-[30%] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <p className="mt-12 text-[10px] font-black uppercase text-white/20 tracking-[0.4em] animate-pulse">
        Secured by Guidewire Parametric Shield
      </p>
    </div>
  );
}
