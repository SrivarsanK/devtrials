    ...
    <div className="w-full max-w-lg mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="text-center space-y-4">
        <div className="w-20 h-20 rounded-3xl bg-primary/10 flex items-center justify-center mx-auto relative group">
           <KeyRound className="w-10 h-10 text-primary drop-shadow-[0_0_15px_rgba(249,115,22,0.6)]" />
      ...
      <div className="space-y-8">
        <AnimatePresence mode="wait">
          {!otpMode ? (
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <Button 
                  ...
                  disabled={loading}
                  className="flex-1 h-16 bg-gradient-to-r from-primary to-primary-dark hover:opacity-90 active:scale-95 transition-all font-black text-lg rounded-[32px] flex items-center justify-center gap-3 border-none shadow-[0_0_30px_-5px_rgba(249,115,22,0.4)]"
                >
            ...
            >
              <div className="space-y-3">
                <label className="text-[10px] font-black text-white/30 tracking-[0.3em] uppercase ml-1 flex justify-between">
