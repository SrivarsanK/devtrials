  ...
  return (
    <div className="min-h-screen bg-[#0e0e0e] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="mb-8 flex flex-col items-center gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <h1 className="text-2xl font-manrope font-black text-white tracking-tight uppercase">Gig<span className="text-primary text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-300">Shield</span> Activation</h1>
      </div>
