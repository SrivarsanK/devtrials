    ...
    <div className="w-full max-w-lg mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="text-center space-y-4">
        <div className="w-20 h-20 rounded-3xl bg-primary/10 flex items-center justify-center mx-auto relative group">
           <FileText className="w-10 h-10 text-primary drop-shadow-[0_0_15px_rgba(255,70,37,0.6)]" />
      ...
      <div className="space-y-8">
        <AnimatePresence mode="wait">
          {!file ? (
            ...
            >
              ...
              >
                <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center mb-6 border border-white/5 group-hover/upload:bg-primary/20 transition-all">
                  <Upload className="w-10 h-10 text-muted-foreground/60 group-hover/upload:text-primary transition-colors" />
                </div>
                <h3 className="text-xl font-display font-black text-white tracking-tight uppercase">
                  <Translate text={label} />
                </h3>
                <p className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-[0.2em] mt-3">
            ...
            <motion.div 
              ...
              className="p-8 glass-strong border border-primary/50 relative overflow-hidden rounded-[40px] shadow-[0_0_30px_rgba(16,185,129,0.1)]"
            >
               ...
               <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1 overflow-hidden">
                     <h4 className="text-xl font-display font-black text-white tracking-tight uppercase truncate">{file.name}</h4>
        ...
        <div className="flex gap-4 pt-6">
          ...
          <Button 
            ...
            className="flex-1 h-16 bg-primary hover:bg-primary/90 text-white transition-all font-black text-lg rounded-[32px] flex items-center justify-center gap-3 border-none shadow-[0_0_40px_-5px_rgba(255,70,37,0.4)] disabled:opacity-20 disabled:grayscale transition-all"
          >
            {uploading ? (
